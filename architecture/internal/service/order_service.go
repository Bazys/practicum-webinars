// Здесь мы применили Dependency Inversion (DIP).
// Сервис не идет в базу данных сам.
// Он говорит: "Мне нужен кто-то, кто умеет выполнять UserChecker".
// Что мы выиграли?
// Теперь OrderService можно протестировать юнит-тестами за 5 секунд,
// передав сюда фейковые моки, без запуска HTTP сервера!
package service
